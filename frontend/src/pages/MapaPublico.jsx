...
import SelectorMapaBase from '../components/mapa/SelectorMapaBase.jsx'
...
function MapaPublico() {
  ...
  return (
    // Contenedor full-screen relativo para que los paneles flotantes se posicionen correctamente
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      {/* Se renderiza dentro del buscador mismo con posicionamiento absoluto */}
      <BuscadorPredial />
      ...
      {/* ── Ficha del predio seleccionado (derecha) ──────────────────────── */}
      <FichaPredio />

      {/* ── Selector de mapa base (abajo al centro) ─────────────────────── */}
      <SelectorMapaBase />
    </div>
  )
}
